...
const[loading, setLoading] = useState(false)
  ...
  return (
    <div className='w-full h-[100vh] bg-cover  flex justify-center items-center' style={{backgroundImage: `url(${bg})`}}>
      ...
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000047] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp} >
...
<input type={showPassword ? "text" : "password"} placeholder="password" className='w-full h-full rounded-full outline-none bg-transparent  placeholder-gray-300 px-[20px] py-[10px]  text-[18px]' required onChange={(e) => setPassword(e.target.value)} value={password}/>
...
<p className='text-[white] text-[18px] cursor-pointer' onClick={() => navigate("/signin")} >Already hava an account ? <span className='text-blue-400' >Sign In</span></p>
</form>
    </div>
  )
}
